...
export const HIT_LINE_Y = CANVAS_HEIGHT * 0.87;
export const OVERLAY_HEIGHT = 0;
export const PROGRESS_BAR_HEIGHT = 0;
export const NOTE_RADIUS = 38;
...
export const LEAD_IN_SEC = (CANVAS_HEIGHT * 0.87) / BASE_PIXELS_PER_SECOND;
// Height of the echo zone below the hit line where passed notes fade out
export const ECHO_ZONE = 110;
